...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        JLabel pincode = new JLabel("Exisisting Account:");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String exisistingaccount = null;
        if (eyes.isSelected()){
            exisistingaccount = "Yes";
        } else if (eno.isSelected()) {
            exisistingaccount = "No";
        } 
        ...
        try {
            Conn c = new Conn(); 
            String query = "insert into signuptwo values('"+formno+"','"+sreligion+"','"+scategory+"', '"+sincome+"', '"+seducation+"', '"+soccupation+"', '"+span+"', '"+saadhar+"', '"+seniorcitizen+"', '"+exisistingaccount+"')";
